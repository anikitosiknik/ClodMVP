...
import { FETCH_CREATE_CLOTH, FETCH_GET_CLOTHS, TOGGLE_CHOOSED_CLOTH, UPDATE_CLOTHS } from "../actionTypes";
...
export const updateCloths = (payload: clothState) => ({type: UPDATE_CLOTHS, payload})
export const toggleChoosedCloth = (id: string) => ({type: TOGGLE_CHOOSED_CLOTH, payload: id})
